...
final class NewsSearchService
{
    ...
    private function matchScore(array $entry, array $terms): float
    {
        ...
        $semanticScore = $this->semanticSimilarityScore($entry, $text);
        if ($semanticScore > 0.0) {
            $score += $semanticScore;
        }
        $this->lastSemanticBoost = $semanticScore;
